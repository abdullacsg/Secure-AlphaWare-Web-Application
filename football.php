...
<html>
<head>
    <title>AlphaWare - Football Products</title>
            ...
            <div id="product">
                ...
                while($fetch = $result->fetch_assoc()) {
                    ...
                    if ($qty > 5) {
                        ...
                        echo "<center>";
                        echo "<a href='details.php?id=".$pid."'><img class='img-polaroid' src='photo/".htmlspecialchars($fetch['product_image'])."' height='300' width='300'></a>";
