	...
	<div id="header" style="position:fixed;">
		...
		<label>alphaware</label>
			...
			<ul>
				...
				<li>Welcome:&nbsp;&nbsp;&nbsp;<a><i class="icon-user icon-white"></i><?php echo htmlspecialchars($admin_username, ENT_QUOTES, 'UTF-8'); ?></a></li>
			</ul>
	</div>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
		...
		<div class="alert alert-info">
			<table class="table table-hover" style="background-color:;">
				...
				<?php
            $result = mysqli_query($conn, "SELECT email, message FROM contact"); // remove ORDER BY id
if (!$result) {
